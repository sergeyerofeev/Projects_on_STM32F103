...
int main(void)
{
  ...
  while (1) {
    if (flag_exti1) {
      ...
      status = HAL_I2C_Master_Transmit(&hi2c1, (uint16_t) MLX90393_Address, pTrConf, 1, HAL_MAX_DELAY);
      status = HAL_I2C_Master_Receive(&hi2c1, (uint16_t) MLX90393_Address, pRecData, 7, HAL_MAX_DELAY);
